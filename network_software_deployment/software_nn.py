...
def state_predict():
    while True:
        ...
        #
        # if action[0] == 1:
        #     if action[1] == 1 and action[2] == 1 and action[3] == 1:
        #         print("GRENADE")
        #
        # elif action[0] == 3:
        #     if action[1] == 3:
        ...
        #
        # elif action[0] == 4:
        #     if action[1] == 4 and action[2] == 4:
        #         print("LOGOUT")
        #
        # elif action[2] == 2:
        #     if action[1] == 2 and action[0] != 1: # covered by the above but just left in for now
        #         print("SHIELD")
        #
        # else:
        #     print(f"IDLE {a_x[0]}")
